...
namespace Portal_MovilEsales.Services.ClienteServices.ViewModels.NuevoPedido.GuardarPedidoBorrador
{
    public class GuardarPedidoBorrador
    {
        ...
        public List<ListadoProductoGuardarPedidoBorrador> detallePedido { get; set; }
